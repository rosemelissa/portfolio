    ...
    <div id="playlist-converter" className="project">
      ...
      <div className="project-main-content">
        <h3 className="project-tagline">
          Playlist converter built using: OAuth2.0, React, Node.js, TypeScript, HTML, CSS
        </h3>
        <div className="nav-bar">
          ...
          <p
            ...
            onClick={() =>
              window.open(
                "https://github.com/rosemelissa/playlist-converter-frontend"
              )
            }
          >
            Repository
        ...
        <div className="content">
          <p>
            This app is currently in Spotify's development mode, which means
        ...
        {collapsibleOpen && (
          <>
            <p>Username: rosemelissa.playlist.converter@gmail.com</p>
        ...
        <div className="loom-div">
          <iframe
            ...
            title="playlist-converter-demo"
            src="https://www.loom.com/embed/35c5c623dd714c4eb2704a3524571e9f"
            frameBorder="0"
            allowFullScreen
          ></iframe>
        </div>
        ...
        <ul>
          ...
          <li>Manually search for songs where the converter wasn't able to find a match</li>
        </ul>
      </div>
    </div>
  );
